...
import { blockUser, dummy1, dummy2, dummyImg, likeHome, locationPin, ratingStar, stars, updateRating, warningImg } from '../../../../assets/images';
                ...
                loading ? renderLoader() : <ScrollView style={{ flex: 1 }}>
                    <View style={[styles.carouselContainer]}>
                        ...
                        <View style={styles.detailContainer}>
                            ...
                            <DetailItem label="Languages" value={`${buddyDetail?.user?.languages !== null ? buddyDetail?.user?.languages : ''}`} />
